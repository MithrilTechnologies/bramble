...
The [`OperationPermissions`](https://pkg.go.dev/github.com/MithrilTechnologies/bramble/bramble#OperationPermissions) type defines which fields can be requested for a given query.
